;
CKEDITOR.dialog.add("textarea",function(A){return{title:A.lang.textarea.title,minWidth:350,minHeight:220,onShow:function(){delete this.textarea;
var B=this.getParentEditor().getSelection().getSelectedElement();
if(B&&B.getName()=="textarea"){this.textarea=B;
this.setupContent(B)
}},onOk:function(){var D,C=this.textarea,B=!C;
if(B){D=this.getParentEditor();
C=D.document.createElement("textarea")
