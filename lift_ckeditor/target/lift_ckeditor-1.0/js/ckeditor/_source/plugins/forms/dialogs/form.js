...
return{title:B.lang.form.title,minWidth:350,minHeight:200,onShow:function(){delete this.form;
var C=this.getParentEditor().getSelection().getStartElement();
var D=C&&C.getAscendant("form",true);
if(D){this.form=D;
this.setupContent(D)
...
}function C(E){if(this.getValue()){E.setAttribute(this.id,this.getValue())
}else{E.removeAttribute(this.id)
