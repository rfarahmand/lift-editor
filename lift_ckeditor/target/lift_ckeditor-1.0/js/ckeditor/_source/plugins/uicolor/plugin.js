...
CKEDITOR.scriptLoader.load(CKEDITOR.getUrl("_source/plugins/uicolor/yui/yui.js"));
A.element.getDocument().appendStyleSheet(CKEDITOR.getUrl("_source/plugins/uicolor/yui/assets/yui.css"))
}});